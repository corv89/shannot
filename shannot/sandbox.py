        ...
        if check and not result.succeeded():
            ...
            if result.stderr:
                ...
                if (
                    ...
                    error_msg += (
                        ...
                        "\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
                        "\n"
                        "\nUnprivileged user namespace creation is blocked on this system."
                        "\n"
                        "\nCommon causes:"
                        "\n  • Ubuntu 24.04+ has AppArmor restricting unprivileged user namespaces"
                        "\n  • Kernel user namespace support is disabled"
                        "\n  • Running in a restricted container/VM environment"
                        "\n"
                        "\n── Quick Fixes ─────────────────────────────────────────────"
                        "\n"
                        ...
                        "\n"
                        "\n  Alternative: Use a different profile"
                        "\n    # Some profiles work without user namespaces"
                        "\n    shannot --profile diagnostics ls /"
                        "\n"
                        "\n── Documentation ───────────────────────────────────────────"
                    ...
                    error_msg += (
                        ...
                        "\nwhich is typically not available in containers for security reasons."
                        "\n"
                        "\n── Solutions ───────────────────────────────────────────────"
                        "\n"
                        "\n  Recommended approaches:"
                        "\n    1. Use a remote Linux server instead"
                        "\n       shannot remote add myserver --host linux-server.local"
                        "\n       shannot --target myserver ls /"
                        "\n"
                        "\n    2. Use a real Linux VM (not a container)"
                        "\n       • Ubuntu Desktop VM"
                        "\n       • Fedora Workstation VM"
                        "\n       • WSL2 on Windows (supports namespaces)"
                        "\n"
                        "\n    3. Switch to native Linux"
                        "\n       • Install Ubuntu, Fedora, or another Linux distro"
                        "\n"
                        "\n  Not recommended:"
                        "\n    • Running containers with --privileged flag (security risk)"
                        "\n"
                        "\n── Documentation ───────────────────────────────────────────"
                        "\n  https://github.com/corv89/shannot/blob/main/docs/troubleshooting.md#container-restrictions"
                        "\n  https://github.com/corv89/shannot/blob/main/docs/configuration.md#remote-execution"
                        "\n"
                        "\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
                    )
                elif "bwrap: command not found" in result.stderr or "bwrap: not found" in result.stderr:
                    error_msg += (
                        "\n\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
                        "\n BUBBLEWRAP NOT INSTALLED"
                        "\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
                        "\n"
                        "\nBubblewrap (bwrap) is required but not installed on this system."
                        "\n"
                        "\n── Install Bubblewrap ──────────────────────────────────────"
                        "\n"
                        "\n  Debian/Ubuntu:"
                        ...
                        "\n    bwrap --version"
                        "\n"
                        "\n── Alternative: Use Remote Execution ───────────────────────"
                        "\n  If you can't install bubblewrap locally, use a remote server:"
                        "\n    shannot remote add myserver --host linux-server.local"
                        "\n    shannot --target myserver ls /"
                        "\n"
                        "\n── Documentation ───────────────────────────────────────────"
                    ...
                    error_msg += (
                        ...
                        "\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
                        "\n"
                        "\nThis may be a permissions or capability issue."
                        "\n"
                        "\n── Diagnostic Commands ─────────────────────────────────────"
                        ...
                        "\n"
                        "\n  Check AppArmor restrictions (Ubuntu 24.04+):"
                        "\n    cat /proc/sys/kernel/apparmor_restrict_unprivileged_userns"
                        "\n"
                        "\n── Documentation ───────────────────────────────────────────"
                        "\n  https://github.com/corv89/shannot/blob/main/docs/troubleshooting.md#permission-errors"
                        "\n"
                        "\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
                    )
            if not result.stderr and not result.stdout:
                error_msg += (
                    ...
                    "\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
                    "\n"
                    "\nThe command produced no output. This could mean:"
                    "\n  • Command requires stdin/interactive input"
                    "\n  • Command executable not found in sandbox"
                    "\n  • Command path is incorrect"
                    "\n"
                    "\nTry:"
                    "\n  • Check if the command is in the allowed_commands list"
                    "\n  • Verify the command exists in the sandbox binds"
                    "\n  • Use 'shannot export' to inspect the profile configuration"
                    "\n"
                    "\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
                )
